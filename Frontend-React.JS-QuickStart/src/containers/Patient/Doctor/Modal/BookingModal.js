...
class BookingModal extends Component {
  ...
  handleChangeSelectGenders = (selectedOption) => {
    this.setState({
  ...
  handleConfirmBooking = async () => {
    ...
    if (res && res.errCode === 0) {
      ...
      toast.error('New Appointment Booked Failed');
    }
  };
  ...
  render() {
    ...
    console.log('check datatime now: ', dataTime);
    return (
      <Modal
        isOpen={isOpenModal}
          ...
          <div className="booking-modal-body">
            ...
            <div className="row">
              ...
              <div className="col-6 form-group">
                <label>
                  {' '}
                  <FormattedMessage id="patient.modal-booking.phone-number" />
                </label>
                <input
                  className="form-control"
              ...
              <div className="col-6 form-group">
                <label>
                  {' '}
                  <FormattedMessage id="patient.modal-booking.birthday" />
                </label>
                <DatePicker
                  className="form-control"
              ...
              <div className="col-6 form-group">
                ...
                <Select
                  ...
                  onChange={this.handleChangeSelectGenders}
