...
class ManagePatient extends Component {
  ...
  handleOnChangeDatePicker = (date) => {
    this.setState(
      ...
      async () => {
        // callback to handle asynchronous
  ...
  handleBtnConfirm = (item) => {
    ...
    console.log('check btnConfirm at ManagePatient: ', item);
  ...
  sendRemedy = async (data) => {
    ...
    console.log('check resSendRemedy: ', res);
    if (res && res.errCode === 0) {
      this.setState({
        isShowLoading: false,
      });
  ...
  render() {
    console.log('check state reducer: ', this.state);
